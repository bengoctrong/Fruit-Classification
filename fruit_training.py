...
#read folder kind of fruit form path
...
h5f_data = h5py.File('D:\\project\\fruit-classification\\output\\data.h5', 'w')
h5f_data.create_dataset('dataset_1', data=np.array(rescaled_features))

h5f_label = h5py.File('D:\\project\\fruit-classification\\output\\labels.h5', 'w')
